...
public class TruyenCuoiAdapter extends RecyclerView.Adapter<TruyenCuoiAdapter.MyRecycleview> {
    ...
    public void onBindViewHolder(@NonNull final MyRecycleview holder, final int position) {
        ...
        final TruyenCuoi truyenCuoi = truyenCuoiList.get(position);
        ...
        holder.itemView.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                            ...
                            bundle.putString("i", String.valueOf(truyenCuoiList.get(position).idName));
                            intent.putExtra("TT", bundle);
                            mContext.startActivity(intent);
            }
        });
        if (truyenCuoiList.get(position).getLike() == 1){
        ...
        holder.checkBoxLike.setOnCheckedChangeListener(new CompoundButton.OnCheckedChangeListener() {
            ...
            public void onCheckedChanged(CompoundButton buttonView, boolean isChecked) {
                if (holder.checkBoxLike.isChecked()) {
                    ...
                    sqLiteDatabase.update("Name", contentValues, "IDName" + "=?", new String[]{String.valueOf(truyenCuoiList.get(position).getIdName())});
